...
class Ciqrcode
{
	...
	public function initialize($config = array()) {
		...
		require "qrcode/qrconst.php";
		require "qrcode/qrtools.php";
		require "qrcode/qrspec.php";
		require "qrcode/qrimage.php";
		require "qrcode/qrinput.php";
		require "qrcode/qrbitstream.php";
		require "qrcode/qrsplit.php";
		require "qrcode/qrrscode.php";
		require "qrcode/qrmask.php";
		require "qrcode/qrencode.php";
