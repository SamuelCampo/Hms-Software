  ...
  <form action="<?=site_url('/rh_param/parametrizacion/buscar')?>" class="col-lg-6 form-inine" method="post" >
      <div class="input-group">
        ...
        <div class="input-group-btn" data-toggle="tooltipb" data-placement="bottom" title="Buscar">
          ...
          <a class="btn bg-navy" href="<?=site_url('/rh_param/parametrizacion/nuevo')?>" data-toggle="tooltipn" data-placement="bottom" title="Nuevo">
