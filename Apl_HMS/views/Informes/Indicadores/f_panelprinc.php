<section class="modal-content" style='padding: 1em 2em'>
  <fieldset>
    <legend>Indicadores Alto Costo</legend>
    <form class="form-inline" role="form" action="<?=site_url('informes/indicadores/continuar')?>" method="post">
