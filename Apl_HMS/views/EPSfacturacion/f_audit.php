  <form class="form-horizontal" method="post" action="<?=site_url('/epsfact/auditoria/factura/guardar/'.$datfac->radicado_t96)?>">
    <legend>Auditoría Cuentas Médicas   <a href="<?=site_url('/epsfact/auditoria/facturagr/'.$datfac->radicado_t96)?>" class="small pull-right">Gestionar por Grupos</a></legend>
