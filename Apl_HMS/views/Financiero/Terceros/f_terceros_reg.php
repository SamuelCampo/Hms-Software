  ...
  <div class="row">
    ...
    <div class="col-lg-10">
      <div class="form-group row">
        ...
        <div class="form-group row">
          <label for="dcomercialtercero" class="col-lg-3 control-label">Dirección Comercial</label>
          <div class="col-lg-5">
            <input name="dcomercialtercero" type="text" class="form-control" id="dcomercialtercero" placeholder="Dirección Comercial" value="<?=$v_f_terceros_reg->direccion_com_t16?>">
          </div>
        </div>
        <div class="form-group row">
