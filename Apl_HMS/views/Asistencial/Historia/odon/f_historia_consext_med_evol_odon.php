...
?>
  ...
  <div class="row contenedorsobreadonopd">
      ...
      <div class="row paddingh">
          ...
          <form id="" class="form-horizontal" role="form" action="<?=site_url("pacientes/historia/guardar/odontologia/".$dathistoria->idps_historia_t4."/evento")?>" method="post">
              <input type="hidden" name="urldestino" value="<?=$this->uri->uri_string()?>" />
              <?
                $this->load->view('Asistencial/Historia/odon/f_historia_evolucion_odon',"",'refresh');
              ?>
