...
?>
  ...
  <div class="row contenedorsobreadonopd">
      ...
      <div class="row paddingh">
            ...
            <form id="form_historia_exam_fisico" class="form-horizontal" role="form" action="<?=site_url("pacientes/historia/guardar/incapacidad/".$dathistoria->idps_historia_t4)?>" method="post">
              <input type="hidden" name="urldestino" value="<?=$this->uri->uri_string()?>" />
              <?
                $this->load->view('Asistencial/Historia/incapacidad/f_historia_inca',"",'refresh');
              ?>
