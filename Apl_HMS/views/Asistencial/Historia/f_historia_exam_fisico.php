<?
  ...
  $arr_exfisc["estado_mental_t64"]=$datconsulta->estado_mental_t64;
...
<div class="col-lg-6">
        ...
        <input name="estado_mental" <?=$deshabingmed?> type="text" class="form-control input-sm" id="estado_mental"  value="<?=$arr_exfisc["estado_mental_t64"]?>" required>
      </div>
