    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
     ...
     <div class="panel panel-default">
       <div class="panel-heading" role="tab" id="headingSix">
         <h4 class="panel-title">
           <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#situacion" aria-expanded="false" aria-controls="situacion">
             <i class="glyphicon glyphicon-record"></i> Situaci&oacute;n Social
           </a>
         </h4>
       </div>
       <div id="situacion" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
         <div class="panel-body">
           <?=$this->load->view('Asistencial/Historia/f_historia_sit_social','','refresh')?>
         </div>
       </div>
     </div>
     <div class="panel panel-default">
       <div class="panel-heading" role="tab" id="headingSix">
         <h4 class="panel-title">
           <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#funcionalidad" aria-expanded="false" aria-controls="funcionalidad">
             <i class="glyphicon glyphicon-record"></i> Nivel de Funcionalidad
           </a>
         </h4>
       </div>
       <div id="funcionalidad" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
         <div class="panel-body">
           <?=$this->load->view('Asistencial/Historia/f_historia_nivel_fun','','refresh')?>
         </div>
       </div>
     </div>  
     <?php endif ?>
...
<!--
    ...
    <div class="panel panel-default">
     ...
     <div class="panel panel-default">
       <div class="panel-heading" role="tab" id="headingSeva">
         <h4 class="panel-title">
           <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeva" aria-expanded="false" aria-controls="collapseSeva">
             <i class="glyphicon glyphicon-record"></i> Habitos
           </a>
         </h4>
       </div>
       <div id="collapseSeva" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeva">
         <div class="panel-body">
           <?$this->load->view('Asistencial/Historia/f_historia_so_hab','','refresh');?>
         </div>
       </div>
     </div>
             ...
             <div class='col-lg-6'>
               ...
               <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                  ...
                  <label for="asma" class="control-label">Riesgo de Hipersexualidad</label>
                </div>
                <div class="col-lg-3">
                  ...
                  <label for="asma" class="control-label">Riesgo Suicida</label>
                </div>
                <div class="col-lg-3">
                  ...
                  <label for="cancer" class="control-label">Riesgo de Agitacion</label>
                </div>
           
                <div class="col-lg-3">
                  <?=$this->load->view('Genericas/gen_radio_check',array("tipo"=>"checkbox","nombre"=>"r_fuga","valor"=>"SI","actual"=>$datconsulta->r_fuga),true)?>
                  <label for="cardiovascular" class="control-label">Alto Riesgo de Fuga</label>
                </div>
                <div class="col-lg-3">
                  ...
                  <label for="diabetes" class="control-label">Alergia</label>
                </div>
                <div class="col-lg-3">
                  ...
                  <label for="dijestivas" class="control-label">Riesgo de Biologico</label>
                </div>
                <?php endif ?>
              </div>
            </div>
