<script type="text/javascript">
  ...
  $( ".cum_desca" ).autocomplete({
    ...
    $('.cum_desc').blur(function(event) {
      var valor = $(this).val();
      if (valor.indexOf('NO POS') != -1){
        r = confirm('Esta solicitando un medicamento no pos ?');
          if (r){
            $('#nopos').css('display', 'block');
          }
      }
    });
    ...
    function comprobarmeds(valor){
      ...
      var buscado3=/POLVO/;
      var buscado4=/AMPOLLA/;
      var buscado5=/AEROSOL/;
      var buscado6=/INHALADOR/;
      var buscado7=/GOTAS/;
      console.log(medicamento,buscado,buscado2,buscado3,buscado4,buscado5,buscado6,buscado7);
  
      if(buscado.test(medicamento) || buscado2.test(medicamento) || buscado3.test(medicamento)| buscado4.test(medicamento) || buscado5.test(medicamento) || buscado6.test(medicamento) || buscado7.test(medicamento)){
