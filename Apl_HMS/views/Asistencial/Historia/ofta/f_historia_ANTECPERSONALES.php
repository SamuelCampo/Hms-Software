          <?php  //$actual=$this->CI->checked($this->CI->data,'PATOLOGICOS','PATOLOGICOS'); 
                  // debug($actual);
                    /*if($actual ==false){
          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <div class="form-group">
                <div class="col-lg-3">
                  <?=$this->load->view('Genericas/gen_radio_check',array("tipo"=>"checkbox","nombre"=>"antecedentes[PATOLOGICOS][patologicos]","valor"=>"SI","actual"=>$datconsulta->patologicos_t66),true)?>
                  <label for="drogas" class="control-label">Patologicos</label>
                </div>
                <div class="col-lg-3">
                  <?=$this->load->view('Genericas/gen_radio_check',array("tipo"=>"checkbox","nombre"=>"antecedentes[PATOLOGICOS][congenitos]","valor"=>"SI","actual"=>$datconsulta->congenitos_t66),true)?>
                  <label for="tabaco" class="control-label">Congenitos</label>
                </div>
