 ...
 <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        <?=$this->load->view('Asistencial/Historia/ofta/f_historia_ANTECPERSONALES',array("tipoantec"=>"PATOLOGICOS"))?>
      </div>
    </div>
  </div>
  <div class="panel panel-default">
           ...
           <div class="panel-heading" role="tab" id="headingSix">
             <h4 class="panel-title">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSixAQ" aria-expanded="false" aria-controls="collapseSix">
                 <i class="glyphicon glyphicon-record"></i> QUERATOMETRIA MOTILIDAD OCULAR BIOMICROSCOPIA
               </a>
             </h4>
           </div>
           ...
           <div class="panel-heading" role="tab" id="headingSix">
             <h4 class="panel-title">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSixeawil1" aria-expanded="false" aria-controls="collapseSix">
                 <i class="glyphicon glyphicon-record"></i> OFTALMOSCOPIA
               </a>
             </h4>
           </div>
           <div id="collapseSixeawil1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
             <div class="panel-body">
               <?=$this->load->view('Asistencial/Historia/ofta/f_historia_REVSISTEMASOPTO','','refresh')?>
             </div>
           </div>
         </div>
       </div>
           ...
           <div class="panel-heading" role="tab" id="headingSix">
             <h4 class="panel-title">
               <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSixe10" aria-expanded="false" aria-controls="collapseSix">
                 <i class="glyphicon glyphicon-record"></i> REFRACCION SUBJETIVO Y AFINACION
               </a>
             </h4>
           </div>
               ...
               <div class="panel-body">
                 ...
                 <div class='col-lg-6'>
                   <fieldset>
                     ...
                     <div class="form-group">
                       <div class="col-lg-12">
                        <textarea class="form-control" name="analisis[laboratorios]" rows="6" required><?= $datconsulta->laboratorios_t64?></textarea>
                      </div>
                     </div>
                   </fieldset>
                 </div>
                 ...
                 <div class='col-lg-6'>
                   <fieldset>
                     ...
                     <div class="form-group">
                       <div class="col-lg-12">
                        <textarea class="form-control" name="analisis[conducta]" rows="6" required><?= $datconsulta->conducta_t64?></textarea>
                      </div>
                     </div>
                   </fieldset>
                 </div>
                 ...
                 <div class='col-lg-6'>
                   <fieldset>
                     ...
                     <div class="form-group">
                       <div class="col-lg-12">
                        <textarea class="form-control" name="analisis[planmanejo]" rows="6" required><?= $datconsulta->planmanejo_t64?></textarea>
                      </div>
                     </div>
                   </fieldset>
                 </div>
