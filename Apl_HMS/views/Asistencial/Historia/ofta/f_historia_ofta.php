               ...
               <div class="panel-body">
                 ...
                 <div class='col-lg-6'>
                   <fieldset>
                     ...
                     <div class="form-group">
                       <div class="col-lg-12">
                        <textarea class="form-control" name="analisis[laboratorios]" rows="6" ><?php ?></textarea>
                      </div>
                     </div>
                   </fieldset>
                 </div>
                 ...
                 <div class='col-lg-6'>
                   <fieldset>
                     ...
                     <div class="form-group">
                       <div class="col-lg-12">
                        <textarea class="form-control" name="analisis[conducta]" rows="6" ><?= $datconsulta->conducta_t64 ?></textarea>
                      </div>
                     </div>
                   </fieldset>
                 </div>
                 ...
                 <div class='col-lg-6'>
                   <fieldset>
                     ...
                     <div class="form-group">
                       <div class="col-lg-12">
                        <textarea class="form-control" name="analisis[planmanejo]" rows="6" ><?= $datconsulta->planmanejo_t64 ?></textarea>
                      </div>
                     </div>
                   </fieldset>
                 </div>
