    ...
    <?if($this->Modulo->verifacceso("ASIST")){?>             
         ...
         <ul class="treeview-menu">
           ...
           <?if($v_menuadd_estado ='ADMITIDO' || $v_menuadd_estado='ATENCION MEDICA' || $this->Modulo->usr->su_t0=='SI'){?>
            <? if($this->Modulo->verifacceso("HISTCONSULTA")){?>
              <?php if ($especialidad == 4 || $especialidad == 20 || $this->Modulo->usr->su_t0=='SI'): ?>
            <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/gestionar/'.$v_menuadd_idhitoria.'/consulta')?>"><i class="fa fa-angle-double-right"></i> Consulta</a></li>
            <?php if($especialidad == 8 || $this->Modulo->usr->su_t0=='SI'){ ?>
            <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/gestionar/'.$v_menuadd_idhitoria.'/evolucion_psicologica')?>"><i class="fa fa-angle-double-right"></i> Evolucion Psicologica</a></li>
            <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/gestionar/'.$v_menuadd_idhitoria.'/salud_ocupacional')?>"><i class="fa fa-angle-double-right"></i> Salud Ocupacional</a></li>
            <? } ?>
         <?php endif ?><?
            }?>
            <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/gestionar/'.$v_menuadd_idhitoria.'/trabajo_social')?>"><i class="fa fa-angle-double-right"></i> Trabajo Social</a></li>
        <?php if ($this->db->database == "CLIOFTALMO" || $this->Modulo->usr->su_t0=='SI') { ?>
       <li class="treeview ">
            <a href="#">
         ...
         <ul class="treeview-menu">
           <?if($v_menuadd_estado=='ADMITIDO' || $v_menuadd_estado=='ATENCIÓN MÉDICA' || $this->Modulo->usr->su_t0=='SI'){?>
            <?if($this->Modulo->verifacceso("HISTCONSULTA") || $this->Modulo->usr->su_t0=='SI'){?>
            ...
            <?}?>
            <?if($this->Modulo->usr->roles["rolprinc"]->codrol_t2=='ENF'){?>
              <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/nuevo_ingreso_medico/'.$v_menuadd_idhitoria.'/')?>"><i class="fa fa-angle-double-right"></i> Nota de Enfermeria</a></li>
            <?php } ?>
            
            <?if($this->db->database=='hms_P900887466' || $this->Modulo->usr->su_t0=='SI'){?>
       ...
       <?php if ($this->db->database != "CLIOFTALMO" && $this->db->database != "hms_FUNSABIAM" || $this->Modulo->usr->su_t0=='SI'): ?>
               <li class="treeview ">
            <a href="#">
           <i class="fa fa-angle-double-right"></i>
       ...
       <?php } ?>
      <li><a href="<?=site_url('pacientes/autorizaciones_agenda/autorizaciones/'.$v_menuadd_idhitoria)?>"><i class="fa fa-angle-double-right"></i> Consentimientos Informados </a></li>
      <li><a href="<?=site_url('pacientes/autorizaciones_agenda/crear/'.$v_menuadd_idhitoria)?>"><i class="fa fa-angle-double-right"></i>Autorizaciones</a></li>
       ...
       <li class="treeview">
            ...
            <?}?>
            <?if($v_menuadd_servicio!='consexterna' && $this->Modulo->verifacceso("EVENF") ){?>
                <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/nuevo_ingreso_medico/'.$v_menuadd_idhitoria.'/')?>"><i class="fa fa-angle-double-right"></i>Nota Aux. Enfermeria</a></li>
                <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/gestionar/'.$v_menuadd_idhitoria.'/evolenfer')?>"><i class="fa fa-angle-double-right"></i> Evoluci&oacute;n Enfermer&iacute;a</a></li>  
              <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/medicacion/'.$v_menuadd_idhitoria.'/')?>"><i class="fa fa-angle-double-right"></i> Ctrl. de Medicamentos</a></li>
            <?}?>
            <?if($v_menuadd_servicio!='consexterna' && $this->Modulo->verifacceso("EVTRP") ){?>
              <li><a href="<?=site_url($v_menuadd_servicio.'/'.$v_menuadd_rol.'/gestionar/'.$v_menuadd_idhitoria.'/evoltrp')?>"><i class="fa fa-angle-double-right"></i> Evoluci&oacute;n Terapias</a></li>
            <?}?>
