        ...
        <tr>
          <td>
            <?if(file_exists(FCPATH.$archct)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/CT")?>" data-toggle="tooltip" data-placement="bottom" title="Control">CT</a>
            <?}
            if(file_exists(FCPATH.$archaf)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/AF")?>" data-toggle="tooltip" data-placement="bottom" title="Facturas">AF</a>
            <?}
            if(file_exists(FCPATH.$archus)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/US")?>" data-toggle="tooltip" data-placement="bottom" title="Usuarios">US</a>
            <?}
            if(file_exists(FCPATH.$archac)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/AC")?>" data-toggle="tooltip" data-placement="bottom" title="Consulta">AC</a>
            <?}
            if(file_exists(FCPATH.$archap)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/AP")?>" data-toggle="tooltip" data-placement="bottom" title="Procedimientos">AP</a>
            <?}
            if(file_exists(FCPATH.$archam)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/AM")?>" data-toggle="tooltip" data-placement="bottom" title="Medicamentos">AM</a>
            <?}
            if(file_exists(FCPATH.$archat)){?>
              <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/DescargarRips/'.$reg->remision_t92."/AT")?>" data-toggle="tooltip" data-placement="bottom" title="Otros Procedimientos">AT</a>
            <?}?>
          </td>
          <td>
