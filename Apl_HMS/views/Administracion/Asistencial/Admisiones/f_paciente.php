<div class="container">
        ...
        <div class="form-group row">
         ...
         <label for="estadocivil" class="col-lg-2 control-label" style="display: none">Estado Civil</label>
        ...
        <div class="form-group row">
         ...
         <label for="grupoetnico" class="col-lg-2 control-label" style="display: none">Población de Riesgo</label>
         <div class="col-lg-3" style="display: none">
           <select class="form-control input-sm" name="tipoblacesp" id="tipoblacesp" >
             <option></option>
         ...
         <label for="niveduccod" class="col-lg-2 control-label" style="display: none">Nivel Educativo</label>
          <div class="col-lg-3" style="display: none">
            <select class="form-control input-sm" name="niveduccod" id="niveduccod">
        ...
        <div class="form-group row">
          <div class="col-lg-1">
           ...
           <div class="col-lg-3">
             ...
             <input name="ocupacioncod" type="hidden" id="ocupacioncod" value="<?=$datpaciente->ocupacioncod_t3?>">
           </div>
        ...
        <div class="form-group row">
          <div class="col-lg-1">
           ...
           <div class="col-lg-3" style="display: none">
             <input class="form-control input-sm" name="direccion" type="text"  id="direccion" placeholder=" Direccion" value="<?=$datpaciente->direccion_t3?>">
           </div>
        ...
        <div class="form-group row">
          <div class="col-lg-1">
           ...
           <div class="col-lg-3" style="display: none">
             ...
             <input name="" type="hidden" id="ocupacioncod" value="<?=$datpaciente->ocupacioncod_t3?>">
           </div>
        </div>     
        <div class="form-group row">
          <div class="col-lg-1">
         ...
         <div class="col-lg-3">
           <select name="administradoracod" class="form-control input-sm" value="" required>
             <option></option> 
             <?= $this->load->view('Genericas/gen_menu',$this->Modulo->confmenu($this->tercero->listar_ad(),"cod_t16","desc_t16",$datpacdef->administradoracod))?>
           </select>
         </div> 
       </div>   
       <div class="form-group row">
       ...
       <div class="form-group row">
         ...
         <div class="col-lg-2" >
           <input name="emerg3" type="text" class="form-control input-sm" id="emerg1" placeholder=" Parentesco" value="<?=$datpaciente->emerg1_t3?>">
         </div>
        ...
        <div class="form-group row">
         ...
         <div class="col-lg-3" >
           <input name="" type="text" class="form-control input-sm" id="" placeholder=" Responsable" value="<?=$datpaciente->emerg1_t3?>">
         </div>
       ...
       <div class="form-group row">
         ...
         <div class="col-lg-3" style="">
           <input  name="emerg2tel" type="text" class="form-control input-sm" id="emerg2tel" placeholder="Teléfono" value="<?=$datpaciente->emerg2tel_t3?>">
         </div>
       </div>
       <div class="form-group row">
         ...
         <div class="col-lg-3" >
          <?php //var_dump($destino); ?>
           <select name="ubicacion" class="form-control input-sm" id="ubicacion">
             <?php foreach ($destino as $fila): ?>
               <option value="<?php echo $fila->descripcion_t74 ?>"><?php echo $fila->descripcion_t74 ?></option>
             <?php endforeach ?>
             <option value="PRIORITARIAS">PRIORITARIAS</option>
    ...
    <div class="form-group row">
         <label for="viaing" class="col-lg-2 control-label" style="display:none">Via Ingreso</label>
         <div class="col-lg-3" style="display:none">
         ...
         <label for="viaing" class="col-lg-2 control-label" >Tipo Cuenta</label>
         <div class="col-lg-3" >
