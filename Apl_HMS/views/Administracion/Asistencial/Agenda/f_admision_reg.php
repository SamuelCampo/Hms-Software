  ...
  <div class="nav-tabs-custom">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="tab_paciente">
        <form class="form-horizontal" role="form" action="<?=site_url("consexterna/ADT/gestionar/".$datagenda->historia_t12."/guardar")?>" method="post">
          <?=$this->load->view('Asistencial/Admisiones/f_paciente',"",true);?>
        </form>
      </div>
      <div class="tab-pane" id="tab_cita">
        <form class="form-horizontal" role="form" action="<?=site_url("pacientes/agenda/modificar/".$datagenda->historia_t12."/guardar")?>" method="post">
