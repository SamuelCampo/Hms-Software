...
<div class="tab-pane active" id="tab_motivo">
      ...
      <div class="col-lg-6">
        <textarea name="estadoingreso"class="form-control" rows="5" id="estadoingreso"><?=$historia->estadoingreso_t15?></textarea>
      </div>
      </div>
      </div>
      <div class="row">
      ...
      <div class="form-group">
      <div class="col-lg-6">
        <textarea name="motivoconsulta" class="form-control" rows="5" id="motivoconsulta"><?=$historia->motivoconsulta_t15?></textarea>
      </div>
      </div>
      </div>
      <div class="row">
