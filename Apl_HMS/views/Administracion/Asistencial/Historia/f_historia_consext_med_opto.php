  ...
  <div class="row contenedorsobreadonopd">
      ...
      <div class="row paddingh">
      	<!--<a href="<?//site_url('pacientes/historia/imprimir/citologia/'.$v_menuadd_idhitoria)?>">-->	<!--</a>-->
            <form id="" class="form-horizontal" role="form" action="<?=site_url("pacientes/historia/guardar/optometria/".$dathistoria->idps_historia_t4)?>" method="post">
              <input type="hidden" name="urldestino" value="<?=$this->uri->uri_string()?>" />
              <?
                $this->load->view('Asistencial/Historia/ofta/f_historia_opto',"",'refresh');
              ?>
