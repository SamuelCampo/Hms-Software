      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-10">
          <div class="form-group">
            <label for="fejecucion" class="col-lg-4 control-label">DX Egreso</label>
            <div class="col-lg-8">        
              <input name="dxegreso" type="text" class="form-control" id="dxegreso" placeholder="Dx de Egreso" value="<?=$datconsulta->dxegreso_t64?>">
              <input name="dxegresocod" type="hidden" id="dxegresocod" value="<?=$datconsulta->dxegresocod_t64?>" >  
            </div>
          </div>
          <div class="form-group">
