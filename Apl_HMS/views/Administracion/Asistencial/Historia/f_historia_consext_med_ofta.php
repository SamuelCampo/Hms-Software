...
?>
  ...
  <div class="row contenedorsobreadonopd">
      ...
      <div class="row paddingh">
      	<!--<a href="<?//site_url('pacientes/historia/imprimir/citologia/'.$v_menuadd_idhitoria)?>">-->	<!--</a>-->
            <form id="" class="form-horizontal" role="form" action="<?=site_url("pacientes/historia/guardar/oftalmologia/".$dathistoria->idps_historia_t4)?>" method="post">
              <input type="hidden" name="urldestino" value="<?=$this->uri->uri_string()?>" />
              <?
                $this->load->view('Asistencial/Historia/ofta/f_historia_ofta',"",'refresh');
              ?>
...
<script type="text/javascript">
	...
	function abrir(){
		document.getElementById("collapseFour").setAttribute("class", "collapse in panel-collapse");
		document.getElementById("collapseSix").setAttribute("class", "collapse in panel-collapse");
		document.getElementById("collapseID").setAttribute("class", "collapse in panel-collapse");
		document.getElementById("collapsePM").setAttribute("class", "collapse in panel-collapse");
	}
</script>
