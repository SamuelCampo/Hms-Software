...
<div class="row contenedorsobreadonopd">
      <div class="row panel-heading">
        <legend class="no-margin no-padding">
          &nbsp; &nbsp;HC: <?=$dathistoria->idps_historia_t4?> Ident: <b><?=$dathistoria->identificacion_t3?></b> Nombre: <b><?=$dathistoria->nomcomp_t3?></b><br> Edad: <?=$edad?> 
        </legend>
              ...
              <input type="hidden" name="urldestino" value="<?=site_url('pacientes/censo')?>" />
                <div class="form-group">
                  <div class="row text-center">
                   <button type="submit" name="formularioenviado" value="consultaext" class="btn <?=$this->Planthtml->estilo->colorprinc?>">Guardar</button>
                  </div>
                </div>
