...
<html>
  ...
  <body>
      ...
      <div>       
        ...
        <tr> 
            <td colspan="4" style="border: hidden; border-left: 1px solid black;padding:1em;">
             <b>ESPECIALIDAD </b> <u>&nbsp;&nbsp; <?=$datconsulta->medespec_t64?> &nbsp;&nbsp;&nbsp;</u> 
            </td>
        ...
        <tr> 
            <td colspan="8" style="border: hidden; border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;">
              ...
              <p style="text-align: justify">
                <?=$datconsulta->enfermactual_t64?><br>
                <b>Objetivos: </b><?=$datconsulta->objetivos_t64?><br>
        ...
        <tr> 
            <td colspan="8" style="border: hidden; border-left: 1px solid black;border-right: 1px solid black;">
               <u>
                <?=$hist_orden['NO POS']->noposjust_t67?><br>
        ...
        <tr> 
            ...
            <td style="text-align: center">
             <?=$hist_orden['NO POS']->dosis_t67?><br><?=$hist_orden['NO POS']->udosis_t67?>
            </td>
            <td style="text-align: center">
        ...
        <tr> 
            <td colspan="3" style="text-align: center">
            <?=$detmedhpnp->principioact_t73?><br>
            </td> 
            <td style="text-align: center">
             <?=$detmedhpnp->concentracion_t73?><br>
            </td>
            <td style="text-align: center">
             <?=$detmedhpnp->unidad_t73?><br>
            </td>
            <td style="text-align: center">
            ...
            <td style="text-align: center">
             <?=$hist_orden['HPNP']->cantidad_t67?><br>
            </td>
        </tr>
        <tr> 
            <td colspan="8" style="text-align: center;">
    ...
    <table width="100%" cellspacing="0" cellpadding="1" border="0">  
        <tr>
            <td width="70%">
                FIRMA DEL MEDICO QUE SOLICITA ________________________
            </td>
            <td width="30%">
