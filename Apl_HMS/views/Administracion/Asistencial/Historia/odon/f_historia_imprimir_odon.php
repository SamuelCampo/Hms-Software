  ...
  <div class="row contenedorsobreadonopd">
      <div class="row panel-heading">
        ...
        <div class="form-group">
          ...
          <?if(is_object($datodon) && !is_null($datconsultaso->idps_hist_consulta_so_t99)){?>
          <div class="col-lg-2 no-margin no-padding">
          ...
          <?}else{?>
          <div class="col-lg-2 no-margin no-padding">
            <a style="font-size: 1.3em; font-weight: bold" href="<?=site_url("pacientes/historia/imprimir/epicrisis/".$dathistoria->idps_historia_t4."/odontologia")?>">Epicrisis</a>
           </div>
          <?}?>
        </div>
      </div>
      <div class="row paddingh" style="display:none">
