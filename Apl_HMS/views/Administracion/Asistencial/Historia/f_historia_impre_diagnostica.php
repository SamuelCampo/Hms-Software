      ...
      <div class="form-group">
        ...
        <div class="col-lg-3">
            ...
            <select class="form-control input-sm" name="finalconsu" >
              <option></option>
              <option value="01">01-Atencion del parto</option>
              <option value="02">02-Atencion del recien nacido</option>
              <option value="03">03-Atencion en planificacion familiar</option>
              <option value="04">04-Deteccion de alteraciones de crecimiento y desarollo del menor de 10 a�os</option>
              <option value="05">05-Deteccion de alteracion del desarrollo joven</option>
              <option value="06">06-Deteccion de alteraciones el embarazo</option>
              <option value="07">07-Deteccion de alteraciones el adulto</</option>
              <option value="08">08-Deteccion de alteraciones de agudeza visual</option>
              <option value="09">09-Deteccion de enfermedad profesional</option>
              <option value="10">10-No aplica</option> 
              </select> 
         </div>   
        ...
        <div class="col-lg-3">
            ...
            <select class="form-control input-sm" name="finalproc" >
              <option></option>
              <option value="01">01-Diagnostico</option>
              <option value="02">02-Terapeutico</option>
              <option value="03">03-Proteccion Especifica</option>
              <option value="04">04-Detencion temprana de enfermedad general</option>
              <option value="05">05-Detecci�n Temprana de enfermedad profesional</option>
              <option value="06">06-No aplica</option>
             </select>        
         </div>
        <br/><br/>
</fieldset>