...
<div class="row contenedorsobreadonopd">
      <ul class="nav nav-tabs nav-justified">
        ...
        <?if($this->Modulo->verifacceso("HISTORDEN")){?>
          <li class="text-center menusobreado"><a <?=$botdesabordenes?> class="btn <?=$colbotordenes?> btn-sm" href="<?=site_url('/pacientes/historia/'.$accionmenu.'/'.$dathistoria->idps_historia_t4.'/ordenes')?>"><br>Suministros</a></li>
        <?}?>
