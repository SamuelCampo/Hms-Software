  ...
  if(!empty($datpaciente)){
    foreach($datpaciente as $reg){
      ?>
        <tr>
          <td>
            <a class="btn <?=$this->Planthtml->estilo->colorprinc?> btn-sm" href="<?=site_url('facturacion/factura/registrar/'.$reg->idps_historia_t4."/".$reg->factnum_t96)?>" data-toggle="tooltip" data-placement="bottom" title="Gestionar">
