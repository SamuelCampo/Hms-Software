...
<form action="<?= site_url('facturacion/factura/imprimir/'.$historia->idps_historia_t4)  ?>" name="" method="post">
	...
	<div class="row">
		<div class="col-md-6">
			...
			<input type="hidden" name="codadministradora" id="tercid" value="<?=$historia->administradoracod_t3?>" required>
		</div>
		<div class="col-md-6">
	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="row">
				...
				<div class="col-md-2">
                    ...
                    <a class="btn <?=$this->Planthtml->estilo->colorprinc?>" href="<?=site_url('facturacion/factura/verificar/'.$this->uri->segment(4)."/".$this->uri->segment(5))?>" data-toggle="tooltipn" data-placement="bottom" title="Imprimmir">
		...
		<div class="col-md-3">
			...
			<input type="text" name="total_copago" class="form-control" value="" id="t_c">
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-3">
			<div class="row">
				<div class="col-md-6">
					...
					<input type="text" class="form-control" value="<?= $historia->fingreso_t4 ?>" disabled>
				</div>
				<div class="col-md-6">
					<label for="#">Fecha de Egreso</label>
					<input type="text" class="form-control" value="<?= $historia->fsalida_t4 ?>" disabled>
				</div>
			</div>
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-5 text-center ">
			<br>
			<span class="alert alert-warning">PARA FACTURAR ES NECESARIO QUE NOS CONFIRMES. ESTA OPCIÓN ES IRREVERSIBLE</span>
		</div>
		</div>
	</div><br>
	<br>
	...
	<?php foreach ($ordenes as $fila): ?>
		...
		<div class="row">
			<div class="col-md-1" style="">
				<input type="number" disabled name="cantidad" class="form-control" value="<?= $fila->cantidad_t67  ?>">
				<input type="hidden"  name="cantidad[]" class="form-control" value="<?= $fila->cantidad_t67  ?>">
			</div>
			...
			<?php $contar = count($costos[0]); ?>
					<?php foreach ($costos as $key) { ?>
						...
						<div class="col-md-2" style="margin-left: -30px">
							...
							<input type="number" disabled name="valor" placeholder="" class="form-control" value="<?= round($valor)  ?>">
			...
			<?php $contara = count($medicamentos[0]); ?>
				<?php foreach ($medicamentos as $l) { ?>
					...
					<?php } ?>
			<?php } ?>
			<div class="col-md-2" style="margin-left: -30px"><?php $total_valor = $fila->cantidad_t67*$valor; ?>
				<input type="number" disabled name="Val_total" value="<?= round($total_valor)?>" placeholder="" class="form-control">
			</div>
			<div class="col-md-2" style="margin-left: -30px">
				<input type="checkbox" name="conf[]" value="<?= $fila->idhist_ordenes_t67.'T'.$valor ?>" class="form-control" checked>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<textarea name="autorizacion" class="form-control" ></textarea></div>
	</div>
